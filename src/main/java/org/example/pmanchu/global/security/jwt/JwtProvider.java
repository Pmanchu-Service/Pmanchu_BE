package org.example.pmanchu.global.security.jwt;
...
import org.example.pmanchu.global.security.exception.ExpiredTokenException;
...
public class JwtProvider {
    ...
    public TokenResponse generateToken(String id) {
        String accessToken = generateToken(id, ACCESS_KEY, jwtProperties.getAccessExp());
